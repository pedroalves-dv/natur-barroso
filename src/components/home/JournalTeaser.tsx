...
const POSTS = [
  {
    ...
    title: 'O Lobo-Ibérico no Barroso: Como (e Onde) Observar o Maior Predador da Península',
    excerpt:
  ...
  },
  {
    ...
    title: 'Cascata de Pitões das Júnias: Guia Completo para a Maior Queda de Água do Gerês',
    excerpt:
  ...
  },
  {
    ...
    title: 'Vinho dos Mortos: A Estranha e Deliciosa História do Vinho Enterrado do Barroso',
    excerpt:
    ...
    <section className="py-20 bg-fog">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {POSTS.map((post) => (
            <article key={post.slug} className="group flex flex-col bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="flex flex-col flex-1 p-5">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-xs font-medium text-amber">{post.category}</span>
