        ...
        <nav className="max-w-7xl mx-auto px-4 md:px-6 flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <a
              ...
              className="hidden md:inline-flex items-center justify-center w-10 h-10 rounded-full hover:opacity-80 transition-opacity"
            ...
            <Link
              href={`/${locale}/tours`}
              className="hidden md:inline-flex btn-lg btn-amber min-w-[9rem]"
            >
              {t("bookTour")}
            </Link>
