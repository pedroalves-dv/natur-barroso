  ...
  return (
    <div className="flex flex-col gap-10">
      {categories.map((cat) => {
        const catLabel =
          locale === "pt"
            ? FAQ_CATEGORY_LABELS[cat].pt
            : FAQ_CATEGORY_LABELS[cat].en;
        ...
        return (
          <div key={cat}>
            <h2 className="text-xs  uppercase tracking-widest text-amber mb-4">
              {catLabel}
            </h2>
              ...
              {catItems.map((item) => {
                ...
                return (
                  <div key={id}>
                    ...
                    >
                      <span className="font-medium text-granite text-sm pr-4">
                        {item.question}
                      </span>
                      <svg
                        width="18"
