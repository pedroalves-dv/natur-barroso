...
export const tours: Tour[] = [
  ...
  // ==============================================================
  {
    ...
    title_en: "Granite Village Trail",
    shortDescription:
      "Um passeio entre aldeias esquecidas onde o granito conta séculos de história.",
    shortDescription_en:
      "A walk through forgotten villages where granite tells centuries of history.",
    category: "cultural",
    difficulty: "easy",
    duration: "Meio dia – 4 horas",
    duration_en: "Half day – 4 hours",
    groupSize: { min: 2, max: 12 },
    pricing: [{ label: "Por pessoa", label_en: "Per person", price: 45 }],
    seasonAvailability: ["spring", "summer", "autumn", "winter"],
    coverImage:
      "https://images.unsplash.com/photo-1663082715431-4e027b3d6875?q=80&w=1200",
  ...
  // ==============================================================
  {
    ...
    title_en: "Pitões das Júnias Trail",
    shortDescription:
      "Das ruínas do mosteiro à cascata escondida — um dos dias mais épicos do Parque Nacional.",
    shortDescription_en:
      "From monastery ruins to a hidden waterfall — one of the most epic days in the National Park.",
    category: "hiking",
    difficulty: "moderate",
    duration: "Dia completo – 7 horas",
    duration_en: "Full day – 7 hours",
    groupSize: { min: 2, max: 10 },
    pricing: [{ label: "Por pessoa", label_en: "Per person", price: 65 }],
  ...
  // ==============================================================
  {
    ...
    shortDescription_en:
      "To the edge of the territory — dirt tracks, wild plateaus, and villages without tarmac.",
    category: "4x4",
    difficulty: "moderate",
    duration: "Dia completo – 8 horas",
    duration_en: "Full day – 8 hours",
    groupSize: { min: 2, max: 8 },
    pricing: [
      { label: "Por pessoa", label_en: "Per person", price: 85 },
      { label: "Grupo privado", label_en: "Private group", price: 480 },
    ],
    seasonAvailability: ["spring", "summer", "autumn", "winter"],
    coverImage:
  ...
  // ==============================================================
  {
    ...
    shortDescription_en:
      "Two days, one night, and the feeling of discovering a Portugal you never knew existed.",
    category: "multiday",
    difficulty: "moderate",
    duration: "2 dias / 1 noite",
    duration_en: "2 days / 1 night",
    groupSize: { min: 2, max: 8 },
    pricing: [{ label: "Por pessoa", label_en: "Per person", price: 195 }],
    seasonAvailability: ["spring", "summer", "autumn"],
    coverImage:
