...
export const tours: Tour[] = [
  {
    ...
    shortDescription_en: 'A walk through forgotten villages where granite tells centuries of history.',
    category: 'cultural',
    difficulty: 'easy',
  ...
  },
  {
    ...
    shortDescription_en: 'From monastery ruins to a hidden waterfall — one of the most epic days in the National Park.',
    category: 'hiking',
    difficulty: 'moderate',
  ...
  },
  {
    ...
    shortDescription_en: 'To the edge of the territory — dirt tracks, wild plateaus, and villages without tarmac.',
    category: '4x4',
    difficulty: 'moderate',
  ...
  },
  {
    ...
    shortDescription_en: 'Two days, one night, and the feeling of discovering a Portugal you never knew existed.',
    category: 'multiday',
    difficulty: 'moderate',
