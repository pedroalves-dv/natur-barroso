    ...
    <>
      ...
      <section className="py-16 bg-granite text-fog">
        <div className="max-w-3xl mx-auto px-4 md:px-6 text-center">
          <h2 className="font-serif text-2xl md:text-3xl mb-4">{t('whatsappTitle')}</h2>
          <p className="text-fog/70 mb-8 leading-relaxed">{t('whatsappBody')}</p>
          <a
            href="https://wa.me/351960000000"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 px-8 py-4 bg-[#25D366] text-white rounded-full font-medium hover:bg-[#20bb5a] transition-colors text-sm"
          >
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="grid md:grid-cols-3 gap-10">
            <div>
              ...
              <a href="tel:+351960000000" className="text-granite font-medium hover:text-amber transition-colors">
                +351 960 000 000
              </a>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-granite/70 text-sm leading-relaxed">
                Montalegre, Terras de Barroso<br />
          ...
          <div className="mt-10 w-full h-64 rounded-2xl bg-granite/5 border border-granite/10 flex items-center justify-center">
            <p className="text-granite/30 text-sm">
              {isPt ? 'Mapa interativo disponível em breve' : 'Interactive map coming soon'}
            </p>
          </div>
